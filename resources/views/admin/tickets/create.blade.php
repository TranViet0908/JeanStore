...
<div class="container-fluid">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-ticket-alt me-2"></i>Tạo ticket</h1>
      <p class="text-muted">Nhập thông tin ticket</p>
    </div>
    <div>
      ...
      <form method="post" action="{{ route('admin.tickets.store') }}">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-4">
            ...
            <input name="requester_name" value="{{ old('requester_name') }}" class="form-control" placeholder="Tên khách">
          ...
          <div class="col-md-4">
            ...
            <input name="requester_email" value="{{ old('requester_email') }}" class="form-control" placeholder="email@domain.com">
          ...
          <div class="col-12">
            ...
            <textarea name="content" rows="6" class="form-control" placeholder="Mô tả chi tiết">{{ old('content') }}</textarea>
            @error('content')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
          </div>

          <!-- Ưu tiên, trạng thái, gán, đơn hàng -->
          <div class="col-md-3">
            <label class="form-label fw-bold">Priority</label>
            @php $pr = old('priority','normal'); @endphp
          ...
          <div class="col-md-3">
            ...
            <select name="assigned_to" class="form-control">
              ...
              @foreach($assignees as $a)
                <option value="{{ $a->id }}" @selected(old('assigned_to')==$a->id)>
          ...
          <div class="col-md-3">
            ...
            <input type="number" name="order_id" value="{{ old('order_id') }}" class="form-control" placeholder="ID đơn hàng">
